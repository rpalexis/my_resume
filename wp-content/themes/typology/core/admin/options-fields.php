        ...
        'fields'    => array(
            ...
            array(
             ...
             array(
                ...
                'desc' => esc_html__( 'Note: preferred formats are .mp4 or .webm', 'typology' ),
                'default' => '',
...
Redux::setSection( $opt_name ,  array(
        ...
        'desc'     => esc_html__( 'Manage settings for your archive templates (category, tag, author, index etc...)', 'typology' ),
        'fields'    => array(
            ...
            array(
                ...
                'subtitle'  => esc_html__( 'Check if you want to display dropcap (first letter)', 'typology' ),
                'default'   => true,
                'required'  => array( 'archive_cover', '=', true ),
            ),
        ...
        'fields'    => array(
            ...
            array(
                ...
                'options' => array(
                    ...
                    'h1, h2, h3, h4, h5, h6' => esc_html__( 'H elements', 'typology' ),
...
Redux::setSection( $opt_name, array(
        ...
        'desc' => wp_kses( sprintf( __( 'Specify your ThemeForest username and API Key to enable theme update notification. When there is a new version of the theme, it will appear on your <a href="%s">updates screen</a>.', 'typology' ), admin_url( 'update-core.php' ) ), wp_kses_allowed_html( 'post' ) ),
        'fields' => array(

            array(
                'id' => 'theme_update_username',
                'type' => 'text',
                'title' => esc_html__( 'Your ThemeForest Username', 'typology' ),
                'default' => ''
            ),
            ...
            array(
                ...
                'type' => 'text',
                'title' => esc_html__( 'Your ThemeForest API Key', 'typology' ),
                'desc' => wp_kses( sprintf( __( 'Where can I find my %s?', 'typology' ), '<a href="http://themeforest.net/help/api" target="_blank">API key</a>' ), wp_kses_allowed_html( 'post' ) ),
                'default' => ''
            )
        ) )
);
